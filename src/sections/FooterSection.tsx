  ...
  return (
    <footer className="footer">
      <div className="section-container">
        ...
        >
          <div>
            <div className="footer__logo">AVA CLÍNICA ODONTO | ESTÉTICA</div>
          ...
          <div className="footer__social">
            <a href="https://instagram.com/avaodontoestetica" className="footer__social-link interactive" aria-label="Instagram">
